...
mkdir build
cd build
cmake .. -DGMX_BUILD_OWN_FFTW=ON -DREGRESSIONTEST_DOWNLOAD=ON -DCMAKE_C_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx -DGMX_GPU=CUDA -DGMX_CUDA_TARGET_SM=86 -DCUDA_TOOLKIT_ROOT_DIR=/usr/local/cuda-11.8
